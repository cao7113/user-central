...
ActiveRecord::Schema.define(:version => 20110710183225) do
  ...
  add_index "client_apps", ["app_id"], :name => "index_clients_on_app_id", :unique => true
  add_index "client_apps", ["name"], :name => "index_clients_on_name", :unique => true
